...
public class JdbcTemplateTool {
	...
	public void update(Object po) throws Exception {
		...
		if(sqlAndParams.getSql()!=null) {
			...
			logger.warn(po+"is not Entity,can not update"); 
		}
	}
	...
	public void save(Object po) throws Exception {
		...
		if(!"".equals(autoGeneratedColumnName)){
			//有自增字段
			Number idValue = save(po, autoGeneratedColumnName);
			//把自增的主键值再设置回去
	 ...
	 * @throws Exception
	 */
	private Number save(Object po, String autoGeneratedColumnName) throws Exception {
